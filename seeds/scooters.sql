...
('650e8400-e29b-41d4-a716-446655440003', 'occupied', 45.4230, -75.6990, NOW() - INTERVAL '20 days', NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '30 minutes'),
...
('650e8400-e29b-41d4-a716-446655440006', 'occupied', 45.4270, -75.6940, NOW() - INTERVAL '5 days', NOW() - INTERVAL '15 minutes', NOW() - INTERVAL '15 minutes'),
...
('650e8400-e29b-41d4-a716-446655440009', 'occupied', 45.4240, -75.6870, NOW() - INTERVAL '1 day', NOW() - INTERVAL '45 minutes', NOW() - INTERVAL '45 minutes'),
...
('750e8400-e29b-41d4-a716-446655440003', 'occupied', 45.5030, -73.5690, NOW() - INTERVAL '20 days', NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '30 minutes'),
...
('750e8400-e29b-41d4-a716-446655440006', 'occupied', 45.5070, -73.5640, NOW() - INTERVAL '5 days', NOW() - INTERVAL '15 minutes', NOW() - INTERVAL '15 minutes'),
...
('750e8400-e29b-41d4-a716-446655440009', 'occupied', 45.5140, -73.5570, NOW() - INTERVAL '1 day', NOW() - INTERVAL '45 minutes', NOW() - INTERVAL '45 minutes'),
